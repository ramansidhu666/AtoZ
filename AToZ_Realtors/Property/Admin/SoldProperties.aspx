                ...
                <div class="module-body">
                    <div class="form-horizontal row-fluid">
                        ...
                        <div class="control-group">
                          ...
                          <div class="control-group">
                            <label class="control-label" for="basicinput">Listed Price</label>
                            <div class="controls">
                          ...
                          <div class="control-group">
                            <label class="control-label" for="basicinput">Sold Price</label>
                            <div class="controls">
                                
                                <asp:TextBox ID="Typetxt" runat="server" MaxLength="50" PlaceHolder="Sold Price.." class="span8"></asp:TextBox>
                                <span class="help-inline">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Price required" Display="Dynamic"
